    ...
    <footer className="border-t bg-background">
      <div className="container py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold">VoiceSync</span>
            </div>
            <p className="text-sm text-muted-foreground">Professional audio translation and dubbing platform.</p>
          </div>
        ...
        <div className="mt-8 border-t pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-muted-foreground">© {new Date().getFullYear()} VoiceSync. All rights reserved.</p>
